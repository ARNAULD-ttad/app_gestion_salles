...
class ServiceSalle:
    ...
    def ajouter_salle(self, salle):
        ...
        if not salle.code or not salle.description \
                or not salle.categorie or not salle.capacite:
            return False, "❌ Erreur : Tous les champs sont obligatoires."

        if int(salle.capacite) < 1:
            return False, "❌ Erreur : La capacité doit être supérieure ou égale à 1."
